...
trait FiresPivotEventsTrait
{
    ...
    public function attach($ids, array $attributes = [], $touch = true)
    {
        ...
        if($this->parent->fireModelEvent('pivotAttaching', true, $this->getRelationName(), $idsOnly, $idsAttributes)) {
    ...
    public function detach($ids = null, $touch = true)
    {
        ...
        if($this->parent->fireModelEvent('pivotDetaching', true, $this->getRelationName(), $idsOnly)) {
    ...
    public function updateExistingPivot($id, array $attributes, $touch = true)
    {
        ...
        if($this->parent->fireModelEvent('pivotUpdating', true, $this->getRelationName(), $idsOnly, $idsAttributes)) {
